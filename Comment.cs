    ...
    public class Comment
    {
        ...
        public IEnumerable<Model.CommentNo> Getpage(Model.Page page)
        {
            using (IDbConnection cn =new MySqlConnection(cns))
            {
                ...
                return (IEnumerable<Model.CommentNo>)cn.Query<Model.CommentNO>(sql, page);
            }
        }
        ...
        public int Update(Model.Comment comment)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update Comment set CommentContent=@CommentContent,CommentTime=@CommnetContent where commentId=@commentID";
